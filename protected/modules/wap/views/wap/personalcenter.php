...
<div id="maincontent" class="content-frame" style="display:none">
	...
	<ul id="main-list" class="ul-catalog-listview">
		...
		<li class="catalog-item" id="phonebind" onclick="Toast('功能尚待开放',3000)">
		<div class="list-item-img"></div>
		<div class="list-item-icon"></div>
		<div class="mainarea-in-list"><h4>绑定手机</h4><h5 id="phonebind-desc">您当前尚未绑定手机</h5></div>
		</li>
		<li class="catalog-item" id="cardbind" onclick="Toast('功能尚待开放',3000)">
		<div class="list-item-img"></div>
		<div class="list-item-icon"></div>
