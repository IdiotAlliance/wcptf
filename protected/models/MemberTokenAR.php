 ...
 *
 * The followings are the available columns in table 'member_token':
 * @property string $seller_id
 * @property string $openid
 * @property string $token
 */
class MemberTokenAR extends CActiveRecord
{
	/**
	...
	public function validate($sellerId, $opendId, $token){
		...
		if($result){
			MemberTokenAR::model()->deleteByPK($result->id);
			return true;
		}
		return false;
	}
	 ...
	 * @return MemberTokenAR the static model class
	 */
