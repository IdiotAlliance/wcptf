...
symbols:["circle","diamond","square","triangle","triangle-down"],lang:{loading:"Loading...",months:"1月,2月,3月,4月,5月,6月,7月,8月,9月,10月,11月,12月".split(","),shortMonths:"1月,2月,3月,4月,5月,6月,7月,8月,9月,10月,11月,12月".split(","),weekdays:"星期天,星期一,星期二,星期三,星期四,星期五,星期六".split(","),decimalPoint:".",numericSymbols:"k,M,G,T,P,E".split(","),resetZoom:"缩放重置",resetZoomTitle:"Reset zoom level 1:1",thousandsSep:","},global:{useUTC:!0,
...
function(a){Ea(a)})}};Highcharts.Scroller=Ib;ga(oa.prototype,"缩放",function(a,b,c){var d=this.chart,e=d.options,f=e.chart.zoomType,g=e.navigator,e=e.rangeSelector,h;if(this.isXAxis&&(g&&g.enabled||e&&e.enabled))if(f==="x")d.resetZoomButton="blocked";else if(f==="y")h=!1;else if(f==="xy")d=this.previousZoom,r(b)?this.previousZoom=[this.min,this.max]:d&&(b=d[0],c=d[1],delete this.previousZoom);return h!==s?h:a.call(this,b,c)});ga(Va.prototype,"init",function(a,b,c){E(this,"beforeRender",function(){var a=
this.options;if(a.navigator.enabled||a.scrollbar.enabled)this.scroller=new Ib(this)});a.call(this,b,c)});x(K,{rangeSelector:{buttonTheme:{width:28,height:16,padding:1,r:0,stroke:"#68A",zIndex:7},inputPosition:{align:"right"},labelStyle:{color:"#666"}}});K.lang=u(K.lang,{rangeSelectorZoom:"缩放",rangeSelectorFrom:"从",rangeSelectorTo:"至"});Jb.prototype={clickButton:function(a,b,c){var d=this,e=d.selected,f=d.chart,g=d.buttons,h=f.xAxis[0],i=f.scroller&&f.scroller.getUnionExtremes()||h||{},k=i.dataMin,
...
l=w=v(k||0,Date.UTC(w,0,1));m=m.getTime();m=z(j||m,m)}else{E(f,"beforeRender",function(){d.clickButton(a,b)});return}else n==="all"&&h&&(l=k,m=j);g[e]&&g[e].setState(0);g[a]&&g[a].setState(2);f.fixedRange=i;h?h.setExtremes(l,m,o(c,1),0,{trigger:"rangeSelectorButton",rangeSelectorButton:b}):(c=f.options.xAxis,c[0]=u(c[0],{range:i,min:w}));d.selected=a}},defaultButtons:[{type:"month",count:1,text:"1个月"},{type:"month",count:3,text:"3个月"},{type:"month",count:6,text:"半年"},{type:"ytd",text:"YTD"},{type:"year",
count:1,text:"1年"},{type:"all",text:"全部"}],init:function(a){var b=this,c=a.options.rangeSelector,d=c.buttons||[].concat(b.defaultButtons),e=b.buttons=[],c=c.selected,f=b.blurInputs=function(){var a=b.minInput,c=b.maxInput;a&&a.blur();c&&c.blur()};b.chart=a;a.extraTopMargin=25;b.buttonOptions=d;E(a.container,"mousedown",f);E(a,"resize",f);q(d,b.computeButtonRange);c!==s&&d[c]&&this.clickButton(c,d[c],!1);E(a,"load",function(){E(a.xAxis[0],"afterSetExtremes",function(){if(a.fixedRange!==t(this.max-
